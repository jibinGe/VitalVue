            ...
            {modalCondition &&
                <div className='fixed w-full h-screen overflow-y-auto left-0 top-0 z-50 flex justify-center p-4 md:p-6 bg-black/75'>
                    ...
                    <motion.div
                        ...
                        className={`overflow-hidden relative z-2 m-auto w-full bg-[#252527] rounded-2xl md:rounded-3xl lg:rounded-[30px] shadow-[0px_0px_50px_0px_rgba(0,0,0,.15)] ${innerClass}`}>
                        {title &&
                            <>
