...
export default function Footer() {
    const status = [
        { name: 'Stable', color: '#28D353' },
        { name: 'Warning', color: '#E5DB4C' },
        { name: 'Critical', color: '#E54D4D' },
    ]
    return (
        <div className="min-h-16 bg-[#27272B] shadow-[0_8px_25px_0_rgba(0,0,0,0.8)] flex flex-wrap gap-3 items-center justify-between px-4 md:px-6">
            <div className="flex items-center gap-5">
                <p className='text-base font-normal text-white'>Status Legend:</p>
            ...
            <div className="rounded-xl relative z-1 bg-white/8 min-h-8.5 overflow-hidden flex items-center justify-center gap-2 text-sm font-normal text-white px-3 border border-solid border-[#2CD155]/35">
                ...
                </svg> Connect to VitalVue Server
            </div>
        </div>
    )
}
