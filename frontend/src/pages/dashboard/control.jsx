    ...
    const system_health = [
        {
            ...
            list: [
                ...
                {
                    info: 'Incident Response Time',
                    status: true,
                    title: '2.3 min',
                    des: 'Target: 5 min',
                },
                {
                    info: 'Service Availability (Last 30 Days)',
                    status: true,
                    title: '99.96% availability',
                    des: 'Target: Rolling 30-day average',
                },
            ]
        },
        {
                            ...
                            >
                                <div className="flex items-end flex-wrap gap-4 mt-4 md:mt-5 lg:mt-6">
                                    <Input
                                        ...
                                        placeholder='Hospital name, ID, or Device ID...'
